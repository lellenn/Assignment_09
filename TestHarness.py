...
# LWarner, 2021-Dec-11, Ran code and checked it to make sure it works
# -----------------------------------------#
...
PC.DataProcessor.add_CD((3, 'American Beauty / American Psycho', 'Fall Out Boy'), lstOfCDObjects)
print('Inventory:')
for item in lstOfCDObjects:
    print(item)
